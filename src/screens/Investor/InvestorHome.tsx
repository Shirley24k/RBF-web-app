                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-md:gap-6 max-sm:gap-4 mb-10 max-md:mb-8 max-sm:mb-6">
                    <div className="bg-white rounded-xl p-8 max-md:p-6 max-sm:p-4 shadow-lg border border-gray-100">
                      <div className="flex items-center justify-between mb-6 max-md:mb-4 max-sm:mb-3">
                        <h3 className="text-xl max-md:text-lg max-sm:text-base font-semibold text-gray-900">Investment Overview</h3>
                      ...
                      <div className="space-y-4 max-md:space-y-3 max-sm:space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-base max-md:text-sm max-sm:text-xs text-gray-600">Investment Completion Rate</span>
                    ...
                    <div className="bg-white rounded-xl p-8 max-md:p-6 max-sm:p-4 shadow-lg border border-gray-100">
                      <div className="flex items-center justify-between mb-6 max-md:mb-4 max-sm:mb-3">
                        <h3 className="text-xl max-md:text-lg max-sm:text-base font-semibold text-gray-900">Investor Balance</h3>
                        <CurrencyDollarIcon className="w-8 h-8 max-md:w-6 max-md:h-6 max-sm:w-5 max-sm:h-5 text-blue-500" />
                      </div>
                                              <div className="space-y-4 max-md:space-y-3 max-sm:space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-base max-md:text-sm max-sm:text-xs text-gray-600">Available Balance</span>
                            <span className="font-semibold text-lg max-md:text-base max-sm:text-sm">RM {analytics.investorBalance.toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-base max-md:text-sm max-sm:text-xs text-gray-600">Total Invested</span>
                            <span className="font-semibold text-lg max-md:text-base max-sm:text-sm text-blue-600">RM {analytics.totalInvested.toLocaleString()}</span>
                          </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 max-md:space-y-3 max-sm:space-y-2">
                      {recentApplications.length > 0 ? (
                        recentApplications.map((app: any) => (
                          <div 
                            key={app.id} 
                            className="flex flex-col sm:flex-row sm:items-center justify-between p-4 max-md:p-3 max-sm:p-2 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors"
                          >
